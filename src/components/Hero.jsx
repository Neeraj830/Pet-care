...
function Hero() {
  return (
    <section className="bg-gradient-to-r from-yellow-100 to-pink-100 p-10 flex flex-col lg:flex-row items-center lg:justify-between text-center lg:text-left">
      <div className="mb-10 lg:mb-0 lg:mr-10">
        <h1 className="text-4xl font-bold mb-4">Care of your Little pets.</h1>
      ...
      <img src={catImage1} alt="Cat 1" className="w-48 h-72 lg:w-64 lg:h-96 object-cover rounded-full lg:rounded-3xl shadow-lg" />
      <img src={catImage2} alt="Cat 2" className="w-30 h-32 lg:w-64 lg:h-72 object-cover rounded-full lg:rounded-3xl shadow-lg" />
